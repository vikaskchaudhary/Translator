 ...
 */
package com.translate.poc.util.translate;
...
import com.translate.poc.util.Files;
import com.translate.poc.util.GoogleAPI;
import com.translate.poc.util.GoogleAPIException;
...
public class TranslatorFrame extends javax.swing.JFrame {
	...
	private static final String REFERRER_PATH = System.getProperty("user.home") + System.getProperty("file.separator")
			+ ".gtReferrer",
			API_KEY_PATH = System.getProperty("user.home") + System.getProperty("file.separator")
	...
	public TranslatorFrame() throws IOException {
		...
		if (key.exists()) {
			GoogleAPI.setKey("AIzaSyDTfzSfoz9pvl8nlhvEAhwdnK7sQpheKA");
		}
	...
	private void translate() {
		try {
			toTextArea.setText(getText(fromTextArea.getText().trim(), languageFrom, languageTo));
		} catch (Exception ex) {
			Logger.getLogger(TranslatorFrame.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	private String getText(String trim, Language languageFrom2, Language languageTo2) {
		// TODO Auto-geneGoogleAPI.setHttpReferrer("www.zycus.com");
		// Set the Google Translate API key
		// See:
		// http://code.google.com/apis/language/translate/v2/getting_started.html
		GoogleAPI.setKey("AIzaSyDTfzSfoz9pvl8nlhvEAhwdnK7sQpheKA4");

		String translatedText = null;
		try {
			translatedText = Translate.DEFAULT.execute(trim, languageFrom2, languageTo2);
